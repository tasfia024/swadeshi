                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" disabled value="<?php echo $userData->name; ?>" name="name"
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    <label for="email" class="form-label">Applicant Email <span
                                            class="text-danger">*</span></label>
                                    <input type="email" value="<?php echo $userData->email; ?>" name="email" disabled
                                        class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $userData->mobile_no; ?>" name="mobile_no"
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    <label for="dob" class="form-label">Date of Birth <span
                                            class="text-danger">*</span></label>
                                    <input type="date" value="<?php $userData->dob; ?>" name="dob" class="form-control"
                                        disabled required>
                                </div>
                            </div>
